...
public class PinnedHeaderAdapter extends BaseAdapter implements OnScrollListener, IPinnedHeader ,Filterable
{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) 
            {
                ...
                {
                    case TYPE_ITEM:
                        convertView = li.inflate(R.layout.row_view,null); 	    					
                        break;
                    case TYPE_SECTION:
                        convertView = li.inflate(R.layout.section_row_view,null); 	    					
                        break;
                }
		...
		public int getCurrentSectionPosition(int position) { 
			String list_char=mListItems.get(position).toString().substring(0, 1).toUpperCase(Locale.ENGLISH);
